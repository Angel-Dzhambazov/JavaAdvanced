...
public class MyBigInteger {
	...
	/*
	 * This method finds the larger number and performs the operation of summing the
	 * numbers according to the sign in front of the big number
	 */
	public static String sumBigNumbers(String firstNum, String secondNum) {
		...
		if (firstNum.charAt(0) != '-') {
			...
			if (secondNum.charAt(0) != '-') {
				...
				result = "-"
						+ sum(firstNum.substring(1, firstNum.length()), secondNum.substring(1, secondNum.length()));
			}
		}
		return result;
	}
	/*
	 * This method finds the larger number and performs the operation of subtracting
	 * the numbers according to the sign in front of the big number
	 */
	public static String subtractBigNumbers(String firstNum, String secondNum) {
		String result = null;
		...
		if (firstNum.charAt(0) != '-') {
			...
			if (secondNum.charAt(0) != '-') {
				...
				result = "-" + subtract(firstNum.substring(1, firstNum.length()),
						secondNum.substring(1, secondNum.length()));
			}
		}
		return result;
