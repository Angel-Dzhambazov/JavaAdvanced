...
public class BigIntegerImplementation {
	...
	public BigIntegerImplementation subtract(BigIntegerImplementation second) {
		...
		if (isFirstPositive && isSecondPositive) {
			if (comapreTwoNumbers(firstList, secondList) == 1) {
				return new BigIntegerImplementation(privateSubtract(firstList, secondList));
			} else {
				return new BigIntegerImplementation("-" + privateSubtract(secondList, firstList));
			}
		}
		if (!isFirstPositive && !isSecondPositive) {
			if (comapreTwoNumbers(firstList, secondList) == 1) {
...
//		System.out.println("Imame greshka, vhodnite danni sa vtoriq int: " + second.toString());
	...
	public BigIntegerImplementation add(BigIntegerImplementation second) {
		List<Integer> firstList = this.getDigitsAsList();
		List<Integer> secondList = second.getDigitsAsList();
		boolean isFirstPositive = this.isPositive;
		boolean isSecondPositive = second.isPositive;
...
//		System.out.println("Imame greshka, vhodnite danni sa vtoriq int: " + second.toString());
	...
	private static String privateSubtract(List<Integer> firstNumber, List<Integer> secondNumber) {
