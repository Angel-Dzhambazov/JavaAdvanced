...
public class P10_2_PlusRemove {
    public static void main(String[] args) {
        ...
        ArrayList<int[]> indexesOfElementsToBeRemoved = new ArrayList<>();
            ...
            for (int col = 1; col < matrix.get(row).size(); col++) {
                ...
                try {
                    if (!"".equals(currentChar)
                        ...
                        indexesOfElementsToBeRemoved.add(new int[]{row, col});
                        indexesOfElementsToBeRemoved.add(new int[]{row + 1, col - 1});
                        indexesOfElementsToBeRemoved.add(new int[]{row + 1, col});
                        indexesOfElementsToBeRemoved.add(new int[]{row + 1, col + 1});
                        indexesOfElementsToBeRemoved.add(new int[]{row + 2, col});
                    }
                } catch (Exception error) {
                }
            }
        }
        for (int[] index : indexesOfElementsToBeRemoved) {
